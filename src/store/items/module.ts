...
export const actions: ActionTree<ItemsStateInterface, RootStateInterface> = {
  loadItems({ commit }) {
    ...
    // We will pretend that we have called a resource from an API
    // and it takes 1 second to return the data
    // using a JavaScript setTimeout with 1000 milliseconds as an option
    setTimeout(() => {
...
// we create our instance of the Items store
